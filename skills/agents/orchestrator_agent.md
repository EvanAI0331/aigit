...
Plan one governed opportunity discovery run.

## Contract

- Prefer a small focused loop over broad uncontrolled scanning.
...
- `skills/external/agency-agents/agents-orchestrator.md`
- `skills/external/agency-agents/automation-governance-architect.md`
